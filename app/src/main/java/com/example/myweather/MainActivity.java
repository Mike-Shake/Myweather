...
import com.example.myweather.city_manage.CityManagerActivity;
import com.example.myweather.city_manage.SearchCityActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dingweiIv = findViewById(R.id.text_tv);

        mainVp = findViewById(R.id.main_vp);
//        添加点击事件
        addCityIv.setOnClickListener(this);
        moreIv.setOnClickListener(this);
        dingweiIv.setOnClickListener(this);

        Citydingwei citydingwei = new Citydingwei();
        try {
            citydingwei.initLocation();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.main_iv_more:
                ...
                break;
            case R.id.text_tv:
                intent.setClass(this, Citydingwei.class);
                break;
        }
